...
var config = {
    ...
    sslKey: path.resolve(__dirname, '../javaclient/certs/server/node.key'),
    sslCert: path.resolve(__dirname, '../javaclient/certs/server/node.crt'),
    sslCaCert: path.resolve(__dirname, '../javaclient/certs/ca/ca.crt'),
    products: {
        "": ["123456"], // Fill in with valid device values, eg: "testdevice1": ["DSN1234", "DSN5678"]
    },
};
